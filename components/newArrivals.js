...
const NewArrivals = () => {
  ...
  return (
    <Container direction={isMobile?"column":"row"} type="flex" height="100vh" width={isMobile?"100%":"90%"}>
        <Container padding="0 2em 0 2em" type="flex" direction="column" flex="1" justify="center" align="center" maxHeight={isMobile?"300px":""}>
            <Text color="#444444" size={isMobile?"0.9em":"1.2em"} family="Helvetica neue" spacing='4px'>NEW ARRIVALS</Text>
            <Text wSpace="nowrap" family="Antic didone" size={isMobile?"2em":"2.5em"} weight="bold" margin="0.5em 0 0.5em 0" spacing="1px">&quot;Freshest of the Fresh&quot;</Text>
            ...
            <Button background="#2A5947" width={isMobile?"100%":"50%"}><Link href='/menu'><a><Text size='0.8em' align='center' spacing='4px' color="#FFFEF3">SHOP NOW</Text></a></Link></Button>
        </Container>
        <Container type="flex" flex="1" padding="0 2em 0 2em" align="center" justify="space-around" maxHeight={isMobile?"300px":""}>
